...
namespace BestHTTP
{
    ...
    public sealed class HTTPRequest : IEnumerator, IEnumerator<HTTPRequest>
    {
        ...
        /// <summary>
        /// It can be used with straming. When set to true, no OnStreamingData event is called, the streamed content will be saved straight to the cache if all requirements are met(caching is enabled and there's a caching headers).
        /// </summary>
        ...
        /// </summary>
        public bool IsTimedOut { get { return (!this.UseStreaming || (this.UseStreaming && this.EnableTimoutForStreaming)) && DateTime.Now - this.ProcessingStarted > this.Timeout; } }
